...
//		for (int i = 0; i < 7; i++) {
//			Image originalImage = tileNumImgList[i].getImage();
//			Image scaledImage = originalImage.getScaledInstance(40, 40, Image.SCALE_SMOOTH);
//			tileNumImgList[i] = new ImageIcon(scaledImage);
//		}
    ...
    /* 빈 칸을 눌렀을 때, 인접한 빈 칸을 재귀적으로 열어주는 메서드 */
